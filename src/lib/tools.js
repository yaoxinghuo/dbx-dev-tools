...
export const TOOLS = [
  ...
  { key: "punycode", contributionId: "terry.devtools.punycode", component: PunycodeTool, tags: ["codec", "converter", "domain", "idn", "url"] },
  ...
  { key: "placeholder", contributionId: "terry.devtools.placeholder", component: PlaceholderTool, tags: ["generator", "image", "test"] },
  ...
  { key: "diff", contributionId: "terry.devtools.diff", component: DiffTool, tags: ["text", "diff", "compare"] },
  ...
  { key: "lines", contributionId: "terry.devtools.lines", component: LinesTool, tags: ["text", "sort"] },
  ...
  { key: "filesize", contributionId: "terry.devtools.filesize", component: FileSizeTool, tags: ["converter", "filesize", "unit", "number"] },
...
// Two-tier tags: category-level tags (shared by 2+ tools) render as filter
// cards and card/detail badges; single-tool tags act as search keywords only
// — a chip that would filter down to one tool adds noise, not navigation.
// Cards are ordered by tool count, biggest category first.
